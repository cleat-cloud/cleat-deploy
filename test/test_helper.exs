...
Mox.defmock(CleatDeploy.Apps.IdleShutdownMock, for: CleatDeploy.Apps.IdleShutdown)
Mox.defmock(CleatDeploy.Apps.RuntimeControlMock, for: CleatDeploy.Apps.RuntimeControl)
